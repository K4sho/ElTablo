...
from .views import detail, profile_bb_detail, profile_bb_dd, profile_bb_change, profile_bb_delete
...
urlpatterns = [
    ...
    path('accounts/profile/add/', profile_bb_dd, name='profile_bb_add'),
